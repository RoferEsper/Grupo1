                        ...
                        {cursosFiltrados.length > 0 ? (
                            cursosFiltrados.reverse().map((curso) => (
                                <tr key={curso.id_curso}>
                                    ...
                                    {/* <td>
                                        <Button className='w-100' size="sm" variant='primary' onClick={<VerCurso/>}>Ver</Button>
                                    </td>
                                    ...
                                    <td className="text-center">
                                        <Button className='w-100' size="sm" variant="danger" onClick={() => { borrar(curso.id) }} >Eliminar</Button>
                                    </td> */}
                                </tr>
                            ))
                        ) : (
